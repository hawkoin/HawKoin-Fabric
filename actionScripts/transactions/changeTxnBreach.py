...
def main(argv):
    ...
    # url = 'http://localhost:3000/api/org.hawkoin.network.ChangeTxnBreach'
    url = 'http://35.224.160.182:3000/api/org.hawkoin.network.ChangeTxnBreach'
    
    userString = 'resource:org.hawkoin.network.' + userType + '#' + userID


    json_payload = {
        "$class": "org.hawkoin.network.ChangeTxnBreach",
        "thresh": amount,
        "user": userString
    }
