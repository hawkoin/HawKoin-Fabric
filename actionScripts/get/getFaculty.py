...
def main(argv):
    ...
    #url = 'http://localhost:3000/api/org.hawkoin.network.Faculty/' + id 
    url = 'http://35.224.160.182:3000/api/org.hawkoin.network.Faculty/' + id
    ...
    try:
        ...
        if(status == 500):
            ...
            print('Department: '.ljust(15), parsed_json['dept'])
